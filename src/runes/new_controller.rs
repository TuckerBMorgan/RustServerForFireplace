...
impl NewController {
     ...
     pub fn new(guid: String, controller_type: eControllerType, hero : String, client_id : u32) -> NewController{
            NewController{guid: guid, controller_type: controller_type, hero: hero, client_id : client_id}
     }
}
